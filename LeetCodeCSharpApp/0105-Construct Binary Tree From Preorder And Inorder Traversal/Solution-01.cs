...
public class Solution
{
    ...
    private static TreeNode Build(int[] preorder, int preLow, int preHigh, int[] inorder, int inLow,
        int inHigh)
    {
        ...
        root.left = Build(preorder, preLow + 1, preLow + leftTreeLength, inorder, inLow, 
            inorderRoot - 1);
        root.right = Build(preorder, preLow + leftTreeLength + 1, preHigh, inorder, inorderRoot + 1,
            inHigh);
